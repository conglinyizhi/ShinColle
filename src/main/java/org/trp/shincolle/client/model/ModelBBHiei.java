...
public class ModelBBHiei<T extends EntityShipBase> extends ShipModelHumanoidBase<T> implements IGlowableModel {
    ...
    private static final float SITTING_ALT_TRANSLATE_Y = LegacyPoseOffsets.sittingAltY("ModelBBHiei");
    private static final float RIDING_TRANSLATE_Y = LegacyPoseOffsets.ridingY("ModelBBHiei");
    private static final float SNEAK_TRANSLATE_Y = LegacyPoseOffsets.sneakY("ModelBBHiei");
    private static final float DEAD_TRANSLATE_Y = LegacyPoseOffsets.deadY("ModelBBHiei");
    ...
    private final ModelPart Hair01a;
    ...
    public ModelBBHiei(ModelPart root) {
        ...
        this.Hair01a = this.HairMain.getChild("Hair01a");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Hair02a = HairMain.addOrReplaceChild("Hair02a", CubeListBuilder.create().texOffs(49, 40).mirror().addBox(-6F, -6F, 0F, 6F, 5F, 6F, new CubeDeformation(0F)), PartPose.offsetAndRotation(-2.5F, 12F, 4.7F, 0.1222F, 0.2094F, -0.9599F));

        PartDefinition Hair01a = HairMain.addOrReplaceChild("Hair01a", CubeListBuilder.create().texOffs(49, 40).addBox(0F, -6F, 0F, 6F, 5F, 6F, new CubeDeformation(0F)), PartPose.offsetAndRotation(2.5F, 12F, 4.7F, 0.1222F, -0.2094F, 0.9599F));

        PartDefinition Hair01 = HairMain.addOrReplaceChild("Hair01", CubeListBuilder.create().texOffs(84, 0).addBox(-7.5F, 0F, 0F, 15F, 6F, 7F, new CubeDeformation(0F)), PartPose.offsetAndRotation(0F, 11.2F, 3.8F, 0.5061F, 0F, 0F));
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        applyBasePose(ctx, netHeadYaw, headPitch, ageInTicks, limbSwing);
    ...
    private void applyEquipVisibility(T entity) {
        ...
        boolean showRigging = entity.getEquipFlag(org.trp.shincolle.entity.EntityBBHiei.EQUIP_RIGGING);
        boolean showHat = entity.getEquipFlag(org.trp.shincolle.entity.EntityBBHiei.EQUIP_ANCHOR);
    ...
    private void applyDeadPose() {
        ...
        LegRight01.zRot = -0.576F;
        LegRight02.xRot = 1.309F;
    ...
    private void applyBasePose(PoseContext ctx, float netHeadYaw, float headPitch, float ageInTicks, float limbSwing) {
    ...
    private void applySpecialPoseAdjustments(T entity, PoseContext ctx, float ageInTicks, float limbSwing, float limbSwingAmount) {
        ...
        if (isSitting) {
            ...
            if (sitTick > 256) {
                ...
                Skirt01.xRot = -0.07F;
                Skirt01.y = skirt01DefaultY + (-0.03F * OFFSET_SCALE);
                Skirt02.xRot = -0.16F;
                SkirtB01.xRot = -0.1F;
                Cloth02a1.xRot = -0.84F;
                Cloth02b1.xRot = -0.84F;
                Cloth02c1.xRot = 1.64F;
                Cloth02c2.xRot = -0.3F;
                Cloth02c3.xRot = 0.7F;
                Cloth02c4.xRot = 0.1F;
                Cloth02c1_1.xRot = 1.64F;
                Cloth02c2_1.xRot = -0.3F;
                Cloth02c3_1.xRot = 0.7F;
                Cloth02c4_1.xRot = 0.1F;
                ClothA03.yRot = 0.7F;
                ClothA03.x = clothA03DefaultX + (-0.2F * OFFSET_SCALE);
                ClothA03a.yRot = -0.7F;
                ClothA03a.x = clothA03aDefaultX + (0.2F * OFFSET_SCALE);
                ArmLeft01.xRot = 2.5F;
                ArmLeft01.zRot = 0.1F;
                ArmLeft02.zRot = 1.0F;
                ...
                if (parTick < 30.0F) {
                    ...
                    ArmRight02.zRot = -ArmLeft02.zRot;
                    ClothA03.yRot = 0.7F + az * -2.1F;
                    ClothA03.x = clothA03DefaultX + (-0.2F + az * 0.73F) * OFFSET_SCALE;
                    ClothA03a.yRot = -ClothA03.yRot;
                    ...
                    ArmRight02.zRot = 0.0F;
                    ClothA03.yRot = -1.45F;
                    ClothA03.x = clothA03DefaultX + (0.53F * OFFSET_SCALE);
                    ClothA03a.yRot = 1.45F;
                    ClothA03a.x = clothA03aDefaultX + (-0.53F * OFFSET_SCALE);
                    addCA032 = 0.3F;
