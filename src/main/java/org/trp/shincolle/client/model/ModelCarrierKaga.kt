...
class ModelCarrierKaga<T : EntityShipBase?>(root: ModelPart) : ShipModelHumanoidBase<T?>(), IGlowableModel {
    ...
    private val ClothHR01: ModelPart
    private val ClothHR02: ModelPart
    private val ClothHR03: ModelPart
    ...
    private val clothHR02DefaultY: Float
    private val clothHR03DefaultY: Float
    ...
    private fun applyEquipVisibility(entity: EntityShipBase?) {
        ...
        val show_CatParts = entity.getEquipFlag(EntityCarrierKaga.EQUIP_CAT_PARTS)
        this.Ear01.visible = show_CatParts
        this.Ear02.visible = show_CatParts
        this.Tail01.visible = show_CatParts

        this.EquipABase.visible = entity.getEquipFlag(EntityCarrierKaga.EQUIP_BACK_QUIVER)
        this.EquipB01.visible = entity.getEquipFlag(EntityCarrierKaga.EQUIP_BREASTPLATE)
        this.EquipC01.visible = entity.getEquipFlag(EntityCarrierKaga.EQUIP_RIGGING)
        this.EquipD01.visible = entity.getEquipFlag(EntityCarrierKaga.EQUIP_DECK_HAND)

        val show_Bow = entity.getEquipFlag(EntityCarrierKaga.EQUIP_BOW)
        this.EquipE01.visible = show_Bow
        this.EquipGlove.visible = show_Bow

        this.EquipS01.visible = entity.getEquipFlag(EntityCarrierKaga.EQUIP_SKIRT)

        val show_Shoes = entity.getEquipFlag(EntityCarrierKaga.EQUIP_SHOES)
    ...
    private fun applyBasePose(
        ...
        val hasTail = entity!!.getEquipFlag(EntityCarrierKaga.EQUIP_CAT_PARTS)
        if (hasBag) {
            this.ArmRight01.zRot += 0.15f
        }
        if (hasTail) {
    ...
    companion object {
        val LAYER_LOCATION: ModelLayerLocation =
            ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Shincolle.MODID, "carrier_kaga"), "main")

        private val DEAD_TRANSLATE_Y = deadY("ModelCarrierKaga")
        private val SNEAK_TRANSLATE_Y = sneakY("ModelCarrierKaga")
        private val SITTING_TRANSLATE_Y = sittingY("ModelCarrierKaga")
        ...
        fun createBodyLayer(): LayerDefinition {
            ...
            val EquipABase = BodyMain.addOrReplaceChild(
                ...
                PartPose.offset(-1f, -8f, 3.6f)
            )

            val EquipABelt01 = EquipABase.addOrReplaceChild(
                "EquipABelt01",
                CubeListBuilder.create().texOffs(0, 27).addBox(-13f, 0f, -0.5f, 13f, 0f, 1f, CubeDeformation(0f)),
            ...
            val EquipABody01 = EquipABelt01.addOrReplaceChild(
                ...
                PartPose.offsetAndRotation(-12.5f, -1.5f, 0f, 0f, 0f, -0.7854f)
            )
            ...
            val EquipABelt02 = EquipABody05c.addOrReplaceChild(
                "EquipABelt02",
                CubeListBuilder.create().texOffs(0, 27).addBox(0f, 0f, -0.5f, 18f, 0f, 1f, CubeDeformation(0f)),
            ...
            val Hair00 = HairMain.addOrReplaceChild(
                "Hair00",
                CubeListBuilder.create().texOffs(64, 40).addBox(0f, -2f, -2f, 4f, 4f, 4f, CubeDeformation(0f)),
                PartPose.offsetAndRotation(5f, 4f, 5.5f, 0.0524f, -0.1745f, -0.0873f)
            )

            val Hair01 = Hair00.addOrReplaceChild(
                "Hair01",
                CubeListBuilder.create().texOffs(60, 38).addBox(0f, -3f, -3f, 6f, 9f, 6f, CubeDeformation(0f)),
                PartPose.offset(3f, -1f, 0f)
            )

            val Hair02 = Hair01.addOrReplaceChild(
                "Hair02",
                CubeListBuilder.create().texOffs(63, 39).mirror()
                    .addBox(0f, 0f, -2.5f, 5f, 8f, 5f, CubeDeformation(0f)),
                PartPose.offsetAndRotation(0.6f, 4.2f, 0f, -0.0524f, 0f, 0.1047f)
            )
            ...
            val HairU01 = Hair.addOrReplaceChild(
                "HairU01",
                CubeListBuilder.create().texOffs(82, 0).addBox(-8.5f, 0f, 0f, 17f, 12f, 6f, CubeDeformation(0f)),
            ...
            val ArmRight01 = BodyMain.addOrReplaceChild(
                ...
                PartPose.offsetAndRotation(-7.8f, -8.7f, -0.7f, 0.0524f, 0f, 0.3142f)
            )
            ...
            val Tail01 = Butt.addOrReplaceChild(
                ...
                PartPose.offsetAndRotation(0f, 7.5f, 1f, -0.6981f, 0f, 0f)
            )
