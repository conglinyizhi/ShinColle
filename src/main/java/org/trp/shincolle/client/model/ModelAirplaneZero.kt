...
class ModelAirplaneZero<T : Entity>(root: ModelPart) : EntityModel<T>(), IGlowableModel {
    ...
    companion object {
        ...
        val LAYER_LOCATION: ModelLayerLocation =
            ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Shincolle.MODID, "airplane_zero"), "main")
        ...
        fun createBodyLayer(): LayerDefinition {
            ...
            val Wing02 = BodyMain.addOrReplaceChild(
                ...
                PartPose.offsetAndRotation(-2f, -0.4f, -3.2f, 0f, 0f, 0.0698f)
            )

            val Prop02 = BodyMain.addOrReplaceChild(
                "Prop02",
                CubeListBuilder.create().texOffs(0, 24).addBox(-1f, -1f, 0f, 2f, 2f, 2f, CubeDeformation(0f)),
                PartPose.offset(0f, -1f, -7.5f)
            )
            ...
            val Tank = BodyMain.addOrReplaceChild(
                "Tank",
                CubeListBuilder.create().texOffs(14, 7).addBox(-1f, 0f, 0f, 2f, 2f, 4f, CubeDeformation(0f)),
