...
public class ModelSubmSo<T extends EntityShipBase> extends ShipModelHumanoidBase<T> implements IGlowableModel {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Shincolle.MODID, "subm_so"), "main");

    private static final float OFFSET_SCALE = 16.0F;
    private static final float DEAD_TRANSLATE_Y = LegacyPoseOffsets.deadY("ModelSubmSo");
    private static final float SNEAK_TRANSLATE_Y = LegacyPoseOffsets.sneakY("ModelSubmSo");
    private static final float SITTING_TRANSLATE_Y = LegacyPoseOffsets.sittingY("ModelSubmSo");
    private static final float SPRINT_TRANSLATE_Y = LegacyPoseOffsets.sprintY("ModelSubmSo");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = BodyMain.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(44, 101).addBox(-7F, -14.5F, -6.5F, 14F, 14F, 13F, new CubeDeformation(0F)), PartPose.offsetAndRotation(0F, -11.8F, -0.5F, 0.1047F, 0F, 0F));
        ...
        PartDefinition HairL01 = Hair.addOrReplaceChild("HairL01", CubeListBuilder.create().texOffs(24, 88).addBox(-1F, 0F, 0F, 2F, 9F, 5F, new CubeDeformation(0F)), PartPose.offsetAndRotation(3F, 7F, -6.9F, -0.3643F, 0.9105F, -0.4554F));

        PartDefinition HairL02 = HairL01.addOrReplaceChild("HairL02", CubeListBuilder.create().texOffs(24, 88).addBox(-1F, 0F, 0F, 2F, 12F, 5F, new CubeDeformation(0F)), PartPose.offsetAndRotation(0F, 2.5F, 2F, 0.1745F, -0.5236F, 0.1745F));

        PartDefinition HairR01 = Hair.addOrReplaceChild("HairR01", CubeListBuilder.create().texOffs(24, 88).mirror().addBox(-1F, 0F, 0F, 2F, 11F, 5F, new CubeDeformation(0F)), PartPose.offsetAndRotation(-5.5F, 8F, -7F, -0.1396F, -0.4363F, -0.0873F));
        ...
        PartDefinition Ahoke = Hair.addOrReplaceChild("Ahoke", CubeListBuilder.create().texOffs(39, 21).addBox(0F, -5F, -10.5F, 0F, 11F, 11F, new CubeDeformation(0F)), PartPose.offsetAndRotation(-1F, -7F, -5.5F, 0.2618F, 0.6981F, 0F));

        PartDefinition HairU01 = Hair.addOrReplaceChild("HairU01", CubeListBuilder.create().texOffs(50, 44).addBox(-8.5F, 0F, 0F, 17F, 15F, 7F, new CubeDeformation(0F)), PartPose.offset(0F, -6F, -7.7F));
        ...
        PartDefinition EquipHeadBase = GlowHead.addOrReplaceChild("EquipHeadBase", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 0F, 0F, 0F, new CubeDeformation(0F)), PartPose.offset(0F, -14.8F, 2F));

        PartDefinition EquipC01 = EquipHeadBase.addOrReplaceChild("EquipC01", CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -8F, -6.5F, 9F, 7F, 11F, new CubeDeformation(0F)), PartPose.offsetAndRotation(-3F, -2F, 5F, -0.4363F, 0.5236F, 0F));

        PartDefinition EquipC02 = EquipC01.addOrReplaceChild("EquipC02", CubeListBuilder.create().texOffs(0, 0).addBox(-1F, -1F, -15F, 2F, 2F, 15F, new CubeDeformation(0F)), PartPose.offsetAndRotation(-1F, -6.5F, -5F, -0.1745F, 0F, 0F));

        PartDefinition EquipHead04 = EquipHeadBase.addOrReplaceChild("EquipHead04", CubeListBuilder.create().texOffs(0, 0).addBox(0F, 0F, 0F, 16F, 9F, 16F, new CubeDeformation(0F)), PartPose.offsetAndRotation(0F, -8.5F, -4F, -0.5918F, -0.7156F, 0.4098F));

        PartDefinition EquipHead02 = EquipHeadBase.addOrReplaceChild("EquipHead02", CubeListBuilder.create().texOffs(26, 9).mirror().addBox(-12F, 0F, 0F, 12F, 7F, 16F, new CubeDeformation(0F)), PartPose.offsetAndRotation(-5F, -2.4F, -12F, 0.1745F, 0.1745F, -0.1396F));

        PartDefinition EquipHead01 = EquipHeadBase.addOrReplaceChild("EquipHead01", CubeListBuilder.create().texOffs(26, 9).addBox(0F, 0F, 0F, 12F, 7F, 16F, new CubeDeformation(0F)), PartPose.offsetAndRotation(5F, -2.4F, -12F, 0.1745F, -0.1745F, 0.1396F));

        PartDefinition EquipHead05 = EquipHeadBase.addOrReplaceChild("EquipHead05", CubeListBuilder.create().texOffs(0, 32).addBox(-5.5F, 0F, 0F, 11F, 4F, 2F, new CubeDeformation(0F)), PartPose.offsetAndRotation(0F, -1F, -11.4F, 0.3142F, 0F, 0F));

        PartDefinition EquipHead03 = EquipHeadBase.addOrReplaceChild("EquipHead03", CubeListBuilder.create().texOffs(35, 0).addBox(-6.5F, 0F, -6.5F, 13F, 7F, 13F, new CubeDeformation(0F)), PartPose.offsetAndRotation(0F, -8.8F, -9.5F, -0.4189F, 2.4086F, -0.288F));
        ...
        PartDefinition EquipT01a = GlowArmLeft02.addOrReplaceChild("EquipT01a", CubeListBuilder.create().texOffs(0, 0).addBox(-2F, -3F, -5F, 4F, 6F, 10F, new CubeDeformation(0F)), PartPose.offsetAndRotation(-6.5F, 6.5F, -1F, 0.1396F, 0F, 0F));

        PartDefinition EquipT01b = EquipT01a.addOrReplaceChild("EquipT01b", CubeListBuilder.create().texOffs(0, 17).addBox(-2.5F, -3.5F, 0F, 5F, 7F, 8F, new CubeDeformation(0F)), PartPose.offset(0F, 0F, -12.9F));
    ...
    private void applyEquipVisibility(T entity) {
        ...
        this.EquipHeadBase.visible = entity.getEquipFlag(org.trp.shincolle.entity.EntitySubmSo.EQUIP_HEAD_BASE);
        this.EquipC01.visible = entity.getEquipFlag(org.trp.shincolle.entity.EntitySubmSo.EQUIP_CANNON);
        boolean showNormalBody = entity.getEquipFlag(org.trp.shincolle.entity.EntitySubmSo.EQUIP_NORMAL_BODY);
        ...
        this.EquipT01a.visible = entity.getEquipFlag(org.trp.shincolle.entity.EntitySubmSo.EQUIP_TORPEDO);
    }
