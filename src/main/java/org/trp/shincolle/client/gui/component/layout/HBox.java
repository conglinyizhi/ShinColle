 ...
 * <p>
 * {@link #addChild} automatically positions each child at the correct X offset.
 ...
 * Usage:
 * <pre>{@code
 * HBox toolbar = new HBox(this.leftPos + 10, this.topPos + 10, 4);
 * toolbar.addChild(new IconButton(...));
 * toolbar.addChild(new IconButton(...));
 * toolbar.addChild(new IconButton(...));
 * this.addRenderableWidget(toolbar);
 * }</pre>
 */
public class HBox extends Panel {
     ...
     */
    public HBox(int x, int y, int spacing) {
        super(x, y, 0, 0);
     ...
     */
    @Override
    public HBox addChild(AbstractWidget child) {
