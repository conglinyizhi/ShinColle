...
class SmallShipyardItemRenderer(dispatcher: BlockEntityRenderDispatcher, modelSet: EntityModelSet) :
    BlockEntityWithoutLevelRenderer(dispatcher, modelSet) {
    private val model: ModelSmallShipyard

    init {
        this.model = ModelSmallShipyard(modelSet.bakeLayer(ModelSmallShipyard.LAYER_LOCATION))
    }
    ...
    override fun renderByItem(
        ...
        val consumer = bufferSource.getBuffer(RenderType.entityCutoutNoCull(TEXTURE_ON))
