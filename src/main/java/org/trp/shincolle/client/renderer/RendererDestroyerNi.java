...
public class RendererDestroyerNi extends MobRenderer<EntityDestroyerNi, ModelDestroyerNi<EntityDestroyerNi>> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Shincolle.MODID, "textures/entity/destroyer_ni.png");
    ...
    @Override
    public ResourceLocation getTextureLocation(EntityDestroyerNi entity) {
        return TEXTURE;
    }

    @Override
    protected void scale(EntityDestroyerNi entity, PoseStack poseStack, float partialTickTime) {
        float s = LegacyScale.getScale(entity, this.model);
        poseStack.scale(s, s, s);
    }

    @Override
    protected float getFlipDegrees(EntityDestroyerNi entity) {
