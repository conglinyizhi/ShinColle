...
public class RendererBattleshipYamato extends MobRenderer<EntityBattleshipYamato, ModelBattleshipYamato<EntityBattleshipYamato>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(EntityBattleshipYamato entity) {
        return TEXTURE;
    }

    @Override
    protected void scale(EntityBattleshipYamato entity, PoseStack poseStack, float partialTickTime) {
        float s = LegacyScale.getScale(entity, this.model);
        poseStack.scale(s, s, s);
    }

    @Override
    protected float getFlipDegrees(EntityBattleshipYamato entity) {
