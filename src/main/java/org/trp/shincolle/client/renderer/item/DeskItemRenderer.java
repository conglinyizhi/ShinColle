...
public class DeskItemRenderer extends BlockEntityWithoutLevelRenderer {
    ...
    public DeskItemRenderer(BlockEntityRenderDispatcher dispatcher, EntityModelSet modelSet) {
        super(dispatcher, modelSet);
        this.model = new ModelBlockDesk(modelSet.bakeLayer(ModelBlockDesk.LAYER_LOCATION));
    }
