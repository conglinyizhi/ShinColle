...
public class Config {
    ...
    public static final ModConfigSpec.IntValue SHIP_EXP_MODIFIER;
    public static final ModConfigSpec.IntValue SHIP_EXP_GAIN_MELEE;
    public static final ModConfigSpec.IntValue SHIP_EXP_GAIN_KILL;
    public static final ModConfigSpec.IntValue SHIP_EXP_GAIN_LIGHT_ATTACK;
    public static final ModConfigSpec.IntValue SHIP_EXP_GAIN_HEAVY_ATTACK;
    public static final ModConfigSpec.IntValue SHIP_EXP_GAIN_LIGHT_AIRCRAFT;
    public static final ModConfigSpec.IntValue SHIP_EXP_GAIN_HEAVY_AIRCRAFT;
    public static final ModConfigSpec.IntValue SHIP_MAX_LEVEL_NORMAL;
    public static final ModConfigSpec.IntValue SHIP_MAX_LEVEL_MARRIED;
    public static final ModConfigSpec.IntValue TRAINING_BOOK_LEVEL_MIN;
    public static final ModConfigSpec.IntValue TRAINING_BOOK_LEVEL_MAX;
    public static final ModConfigSpec.BooleanValue DEBUG_LOGGING;
    public static final ModConfigSpec.BooleanValue DEBUG_PERFORMANCE_LOGGING;
    public static final ModConfigSpec.IntValue DEBUG_PERF_SLOW_SHIP_TICK_MS;
    public static final ModConfigSpec.IntValue DEBUG_PERF_SLOW_TASK_TICK_MS;
    public static final ModConfigSpec.IntValue DEBUG_PERF_SLOW_BLOCK_ENTITY_TICK_MS;
    public static final ModConfigSpec.IntValue DEBUG_PERF_SLOW_PROJECTILE_TICK_MS;
    public static final ModConfigSpec.IntValue DEBUG_PERF_SLOW_SERVER_TICK_MS;
    public static final ModConfigSpec.IntValue DEBUG_PERF_MIN_LOG_INTERVAL_TICKS;
    public static final ModConfigSpec.BooleanValue MODERN_KIT_NOTIFY_WHEN_MAXED;
    public static final ModConfigSpec.BooleanValue MODERN_KIT_NOTIFY_WHEN_MAXED_ACTION_BAR;
    public static final ModConfigSpec.IntValue FUEL_DECAY_INTERVAL;
    public static final ModConfigSpec.IntValue FUEL_MOVE_DECAY_FACTOR;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_DD;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_CL;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_CA;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_CAV;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_CLT;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_CVL;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_CV;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_BB;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_BBV;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_SS;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_AP;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_ACTION_LIGHT;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_ACTION_HEAVY;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_ACTION_LIGHT_AIRCRAFT;
    public static final ModConfigSpec.IntValue FUEL_CONSUME_ACTION_HEAVY_AIRCRAFT;
    
    public static final ModConfigSpec.IntValue TICK_FISHING_MIN;
    public static final ModConfigSpec.IntValue TICK_FISHING_MAX;
    public static final ModConfigSpec.IntValue TICK_MINING_MIN;
    public static final ModConfigSpec.IntValue TICK_MINING_MAX;
    public static final ModConfigSpec.BooleanValue TASK_ENABLE_COOKING;
    public static final ModConfigSpec.BooleanValue TASK_ENABLE_FISHING;
    public static final ModConfigSpec.BooleanValue TASK_ENABLE_MINING;
    public static final ModConfigSpec.BooleanValue TASK_ENABLE_CRAFTING;
    public static final ModConfigSpec.IntValue SMALL_SHIPYARD_POWER_MAX;
    public static final ModConfigSpec.IntValue SMALL_SHIPYARD_BUILD_SPEED;
    public static final ModConfigSpec.IntValue SMALL_SHIPYARD_INSTANT_TICKS;
    public static final ModConfigSpec.DoubleValue SMALL_SHIPYARD_FUEL_MAGNIFICATION;
    public static final ModConfigSpec.IntValue LARGE_SHIPYARD_POWER_MAX;
    public static final ModConfigSpec.IntValue LARGE_SHIPYARD_BUILD_SPEED;
    public static final ModConfigSpec.IntValue LARGE_SHIPYARD_INSTANT_TICKS;
    public static final ModConfigSpec.DoubleValue LARGE_SHIPYARD_FUEL_MAGNIFICATION;
    public static final ModConfigSpec.IntValue RING_ABILITY_WATER_BREATHING;
    public static final ModConfigSpec.IntValue RING_ABILITY_SWIM_FLIGHT;
    public static final ModConfigSpec.IntValue RING_ABILITY_UNDERWATER_DIG_CAP;
    public static final ModConfigSpec.IntValue RING_ABILITY_UNDERWATER_FOG_CAP;
    public static final ModConfigSpec.IntValue RING_ABILITY_FIRE_IMMUNITY;
    public static final ModConfigSpec.IntValue DRUM_LIQUID_BASE_RATE;
    public static final ModConfigSpec.IntValue DRUM_LIQUID_ENCHANT_RATE;
    public static final ModConfigSpec.IntValue DRUM_ENERGY_BASE_RATE;
    public static final ModConfigSpec.IntValue DRUM_ENERGY_ENCHANT_RATE;
    ...
    public static final ModConfigSpec.IntValue VOLCORE_FUEL_MAGNITUDE;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> MINING_ENTRIES;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> LOOT_ENTRIES;
    public static final ModConfigSpec.IntValue[] EXP_GAIN_TASK = new ModConfigSpec.IntValue[4];
    public static final ModConfigSpec.IntValue[] CONSUME_GRUDGE_TASK = new ModConfigSpec.IntValue[4];

        public static final ModConfigSpec.DoubleValue HOSTILE_DROP_GRUDGE_RATE;
        public static final ModConfigSpec.IntValue HOSTILE_DEATH_MAX_TICKS;
        public static final ModConfigSpec.IntValue HOSTILE_DESPAWN_BOSS_TICKS;
        public static final ModConfigSpec.IntValue HOSTILE_DESPAWN_MINION_TICKS;
        public static final ModConfigSpec.IntValue HOSTILE_BOSS_COOLDOWN_TICKS;
        public static final ModConfigSpec.IntValue HOSTILE_SPAWN_BOSS_COUNT;
        public static final ModConfigSpec.IntValue HOSTILE_SPAWN_MINION_COUNT;
        public static final ModConfigSpec.BooleanValue HOSTILE_SPAWN_REQUIRE_RING;
        public static final ModConfigSpec.IntValue HOSTILE_MOB_SPAWN_MAX;
        public static final ModConfigSpec.IntValue HOSTILE_MOB_SPAWN_CHANCE_PERCENT;
        public static final ModConfigSpec.IntValue HOSTILE_MOB_SPAWN_GROUPS;
        public static final ModConfigSpec.IntValue HOSTILE_MOB_SPAWN_GROUP_MIN;
    public static final ModConfigSpec.IntValue HOSTILE_MOB_SPAWN_GROUP_MAX;

    public static final ModConfigSpec.BooleanValue SHIP_CAN_TIMEKEEPING;
    public static final ModConfigSpec.DoubleValue SHIP_VOLUME_TIMEKEEPING;
    public static final ModConfigSpec.DoubleValue SHIP_VOLUME_GENERAL;
    public static final ModConfigSpec.DoubleValue SHIP_VOLUME_ATTACK;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> CUSTOM_SOUND_RATES;

    public static final ModConfigSpec.DoubleValue CLIENT_SCALE_HELD_ITEM;
    public static final ModConfigSpec.DoubleValue CLIENT_OFFSET_HELD_ITEM_X;
