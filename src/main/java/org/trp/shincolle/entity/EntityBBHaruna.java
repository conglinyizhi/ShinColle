...
public class EntityBBHaruna extends EntityShipBase {
    ...
    private void applyBuffToNearbyAllies() {
        ...
        for (EntityShipBase ship : ships) {
            ...
            ship.addEffect(new MobEffectInstance(MobEffects.LUCK, duration, amp, false, false));
        }
    }

    @Override
    protected Item getShipSpawnEggItem() {
        return ModItems.BB_HARUNA_SPAWN_EGG.get();
    }
}
