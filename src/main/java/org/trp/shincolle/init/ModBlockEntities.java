...
public class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<DeskBlockEntity>> DESK =
            BLOCK_ENTITY_TYPES.register("blockdesk", () ->
                    BlockEntityType.Builder.of(DeskBlockEntity::new, ModBlocks.DESK.get()).build(null));
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<org.trp.shincolle.block.entity.VolCoreBlockEntity>> VOL_CORE =
            BLOCK_ENTITY_TYPES.register("blockvolcore", () ->
                    BlockEntityType.Builder.of(org.trp.shincolle.block.entity.VolCoreBlockEntity::new, ModBlocks.VOL_CORE.get()).build(null));

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<WayPointBlockEntity>> WAYPOINT =
            BLOCK_ENTITY_TYPES.register("blockwaypoint", () ->
                    BlockEntityType.Builder.of(WayPointBlockEntity::new, ModBlocks.WAYPOINT.get()).build(null));

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<CraneBlockEntity>> CRANE =
            BLOCK_ENTITY_TYPES.register("blockcrane", () ->
                    BlockEntityType.Builder.of(CraneBlockEntity::new, ModBlocks.CRANE.get()).build(null));
}
