...
public class ModTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SHINCOLLE_TAB = CREATIVE_MODE_TABS.register("shincolle_tab", () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                // Keep the primary tab compact; the search tab is still available for variant lookup.
                output.accept(ModItems.EQUIP_AIRPLANE.get());
                output.accept(ModItems.EQUIP_AMMO.get());
                output.accept(ModItems.EQUIP_ARMOR.get());
                output.accept(ModItems.EQUIP_CANNON.get());
                output.accept(ModItems.EQUIP_CATAPULT.get());
                output.accept(ModItems.EQUIP_COMPASS.get());
                output.accept(ModItems.EQUIP_DRUM.get());
                output.accept(ModItems.SHIP_TANK.get());
                output.accept(ModItems.EQUIP_FLARE.get());
                output.accept(ModItems.EQUIP_MACHINEGUN.get());
                output.accept(ModItems.EQUIP_RADAR.get());
                output.accept(ModItems.EQUIP_SEARCHLIGHT.get());
                output.accept(ModItems.EQUIP_TORPEDO.get());
                output.accept(ModItems.EQUIP_TURBINE.get());
