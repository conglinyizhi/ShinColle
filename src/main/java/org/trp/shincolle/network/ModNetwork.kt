...
object ModNetwork {
    ...
    fun register(event: RegisterPayloadHandlersEvent) {
        ...
        registrar.playToServer<C2SBookStatePayload?>(
            ...
            IPayloadHandler { obj: C2SBookStatePayload?, payload: IPayloadContext? -> ModNetwork.handleBookState(payload) }
        )
        registrar.playToServer<C2SDeskGuiPayload?>(
            C2SDeskGuiPayload.Companion.TYPE,
            C2SDeskGuiPayload.Companion.STREAM_CODEC,
            IPayloadHandler { obj: C2SDeskGuiPayload?, payload: IPayloadContext? -> ModNetwork.handleDeskGui(payload) }
        )
        registrar.playToServer<C2SWaypointActionPayload?>(
            ...
            IPayloadHandler { obj: C2SWaypointActionPayload?, payload: IPayloadContext? ->
        ...
        registrar.playToServer<C2SPointerActionPayload?>(
            ...
            IPayloadHandler { obj: C2SPointerActionPayload?, payload: IPayloadContext? ->
        ...
        registrar.playToServer<C2SFormationActionPayload?>(
            ...
            IPayloadHandler { obj: C2SFormationActionPayload?, payload: IPayloadContext? ->
        ...
        registrar.playToServer<C2SDeskOpenShipPayload?>(
            ...
            IPayloadHandler { obj: C2SDeskOpenShipPayload?, payload: IPayloadContext? ->
        ...
        registrar.playToServer<C2SDeskSummonPayload?>(
            ...
            IPayloadHandler { obj: C2SDeskSummonPayload?, payload: IPayloadContext? ->
        ...
        registrar.playToServer<C2STeamDiplomacyPayload?>(
            ...
            IPayloadHandler { obj: C2STeamDiplomacyPayload?, payload: IPayloadContext? ->
        ...
        registrar.playToClient<S2CAdmiralDataSyncPayload?>(
            ...
            IPayloadHandler { obj: S2CAdmiralDataSyncPayload?, payload: IPayloadContext? ->
        ...
        registrar.playToClient<S2CDeskDiplomacySyncPayload?>(
            ...
            IPayloadHandler { obj: S2CDeskDiplomacySyncPayload?, payload: IPayloadContext? ->
    ...
    private fun handleAdmiralDataSync(payload: S2CAdmiralDataSyncPayload, context: IPayloadContext) {
        context.enqueueWork(Runnable {
            ...
            if (player != null) {
                applyAdmiralSync(player, payload.admiralNbt, payload.collectedShips)
    ...
    private fun handleDeskDiplomacySync(payload: S2CDeskDiplomacySyncPayload, context: IPayloadContext) {
        context.enqueueWork(Runnable {
            DeskDiplomacySync.update(
                payload.ownerUuid,
                List.of<UUID?>(*payload.allies),
                List.of<UUID?>(*payload.banned),
                List.of<UUID?>(*payload.displayUuids),
                List.of<String?>(*payload.displayTeamNames),
                List.of<String?>(*payload.displayLeaderNames)
            )
        })
    }
    ...
    private fun handleDeskOpenShip(payload: C2SDeskOpenShipPayload, context: IPayloadContext) {
        context.enqueueWork(Runnable {
            ...
            openOwnedShipFromDesk(player, payload.shipUuid)
        })
    }
