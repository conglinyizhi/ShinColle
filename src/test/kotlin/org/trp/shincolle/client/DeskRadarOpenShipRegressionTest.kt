...
class DeskRadarOpenShipRegressionTest {
    ...
    @Test
    fun radarListShouldStillOpenShipMenuWhenClickingSameShipAgain() {
    ...
    @Test
    fun radarActionButtonShouldKeepLegacySingleSelectionOpenBehavior() {
        val screenSource: String = Files.readString(SCREEN_SOURCE)
    ...
    @Test
    fun serverShouldAuthorizeDeskRadarShipOpenByOwner() {
        val networkSource: String = Files.readString(NETWORK_SOURCE)
