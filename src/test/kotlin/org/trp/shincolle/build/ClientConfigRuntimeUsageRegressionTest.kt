...
class ClientConfigRuntimeUsageRegressionTest {
    ...
    private val SHIP_COMBAT_SOURCE: Path =
    ...
    @Test
    fun clientConfigTogglesShouldRemainConnectedToRuntimeConsumers() {
        val shipBase = Files.readString(SHIP_BASE_SOURCE)
        val shipCombat = Files.readString(SHIP_COMBAT_SOURCE)
