...
class ServicePlayerGuardRegressionTest {
    private val WAYPOINT_SERVICE: Path =
            Path.of("src/main/java/org/trp/shincolle/server/WaypointService.kt")
    private val FORMATION_SERVICE: Path =
            Path.of("src/main/java/org/trp/shincolle/server/FormationService.kt")
    private val POINTER_SERVICE: Path =
            Path.of("src/main/java/org/trp/shincolle/server/PointerInteractionService.kt")

    @Test
    fun waypointServiceShouldKeepExplicitPayloadDispatchBranches() {
        val source: String = Files.readString(WAYPOINT_SERVICE)
    ...
    @Test
    fun formationServiceShouldOnlySyncAfterRealStateChanges() {
        val source: String = Files.readString(FORMATION_SERVICE)
    ...
    @Test
    fun playerStateServiceShouldRejectNoopFormationMutations() {
        val source: String = Files.readString(Path.of("src/main/java/org/trp/shincolle/server/PlayerStateService.kt"))
    ...
    @Test
    fun pointerPayloadServiceShouldOnlySyncRealGroupedSelectionChanges() {
        val source: String = Files.readString(POINTER_SERVICE)
