...
class ShipLegacyCommandCompatibilityRegressionTest {
    ...
    @Test
    fun publicLegacyCommandBranchesShouldStayAvailableToNormalPlayers() {
        val source: String = Files.readString(COMMANDS_SOURCE)
    ...
    @Test
    fun oldManagementCommandArgumentShapesShouldRemainRegistered() {
        val source: String = Files.readString(COMMANDS_SOURCE)
    ...
    @Test
    fun globalStopAiShouldCoverMountsAsWellAsShips() {
