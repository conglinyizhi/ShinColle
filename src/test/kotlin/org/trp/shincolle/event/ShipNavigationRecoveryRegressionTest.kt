...
class ShipNavigationRecoveryRegressionTest {
    ...
    @Test
    fun navigationDebugLoggingShouldNotResetStuckRecoveryProgress() {
        val source: String = Files.readString(NAVIGATION_SOURCE)
        val policy: String = Files.readString(NAVIGATION_POLICY_SOURCE)
    ...
    @Test
    fun legacyPathShouldExposeInvalidCurrentTargetAsMissing() {
        val source: String = Files.readString(LEGACY_PATH_SOURCE)
