...
class ShipPointerRecoveryRegressionTest {
    ...
    @Test
    fun pointerEntityCommandShouldClearAfterRepeatedMoveFailures() {
    ...
    @Test
    fun pointerEntityCommandShouldClearAfterExtendedNoMovement() {
        val brain: String = Files.readString(BRAIN_AI_SOURCE)
        val numbers: String = Files.readString(AI_NUMBERS_SOURCE)
    ...
    @Test
    fun pointerEntityMovementShouldLiveInBrainBehavior() {
        val pointer: String = Files.readString(POINTER_SOURCE)
        val brain: String = Files.readString(BRAIN_AI_SOURCE)
    ...
    @Test
    fun pointerPositionCommandShouldClearEntityCommandAtPublicApiBoundary() {
        val source: String = Files.readString(SHIP_SOURCE)
    ...
    @Test
    fun pointerEntityCommandShouldClearPositionCommandAtPublicApiBoundary() {
        val source: String = Files.readString(POINTER_SOURCE)
