...
class ShipCommandRecoveryRegressionTest {
    private val POINTER_GOAL_SOURCE: Path =
    ...
    @Test
    fun pointerMoveBehaviorShouldUseCentralizedAiNumbersAndCoordinator() {
        val source = Files.readString(POINTER_GOAL_SOURCE)
        val numbers = Files.readString(AI_NUMBERS_SOURCE)
    ...
    @Test
    fun pointerEntityCommandShouldTryTeleportRecoveryBeforeClearingTarget() {
        val brain = Files.readString(POINTER_GOAL_SOURCE)
        val pointer = Files.readString(POINTER_SOURCE)
        val numbers = Files.readString(AI_NUMBERS_SOURCE)
    ...
    @Test
    fun guardBehaviorShouldUseCentralizedAiNumbersAndCoordinator() {
        val source = Files.readString(POINTER_GOAL_SOURCE)
        val numbers = Files.readString(AI_NUMBERS_SOURCE)
