...
class ShipLegacyNbtCompatibilityRegressionTest {
    private val SERIALIZATION_SOURCE: Path =
            Path.of("src/main/java/org/trp/shincolle/entity/base/EntityShipBaseSerialization.kt")

    @Test
    fun legacyShipExtPropsAndInventoryShouldStillLoad() {
        val source = Files.readString(SERIALIZATION_SOURCE)
    ...
    @Test
    fun legacyShipExtPropsBackupShouldBeSavedForward() {
        val source = Files.readString(SERIALIZATION_SOURCE)
        val entitySource = Files.readString(Path.of("src/main/java/org/trp/shincolle/entity/base/EntityShipBase.kt"))
    ...
    @Test
    fun legacyCanDropShouldStillGateDeathSpawnEggDrop() {
        val entitySource = Files.readString(Path.of("src/main/java/org/trp/shincolle/entity/base/EntityShipBase.kt"))
