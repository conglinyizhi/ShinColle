...
class ShipFriendlyFirePrecheckRegressionTest {
    ...
    @Test
    fun lightAndHeavyAttacksShouldRejectSameOwnerTargetsBeforeSpendingAmmo() {
        val source = Files.readString(SHIP_COMBAT)
...
""")) { "Heavy attack should reject same-owner targets before spending ammo" }
    ...
    @Test
    fun sameOwnerCheckShouldCoverPlayersShipsMountsAndAircraft() {
        val source = Files.readString(SHIP_COMBAT)
